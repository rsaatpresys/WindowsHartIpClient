...
namespace FieldCommGroup.HartIPConnect
{
    ...
    public sealed class HartClient
    {
        ...
        public HartIPResponse SendHartRequest(byte[] Request, ushort ByteCount, int Timeout)
        {
        ...
        public HartIPResponse SendHartRequest(byte[] Request, ushort ByteCount)
        {
            var temp = SendHartRequest(Request, ByteCount, HARTIPConnect.USE_SOCKET_TIMEOUT_DEFAULT);
            return temp;
        }
